                                ...
                                <td height="100%" valign="top">
                                    <div style="padding: 32px 18px 24px;">
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="font-size:24px">Đơn hàng của bạn đã huỷ!</span>
                                                </td>
                                                <td align="right">
                                                                        <span
                                ...
                                <td style="padding:0px 20px 18px 20px;line-height:22px;text-align:inherit"
                                    ...
                                    <div>
                                        <div style="font-family:inherit;text-align:inherit">
                                                            <span
                                                                style="color:#222222;font-family:Helvetica;font-size:14px;line-height:22px">Nếu đây là sự nhầm lẫn</span></a><span
